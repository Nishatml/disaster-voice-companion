    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            async function loadData() {
                const forecast = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchDisasterForecast"])();
                setData(forecast);
                setLoading(false);
            }
            loadData();
...
async function fetchDisasterForecast() {
    try {
        // Dynamic origin for GitHub Codespaces & local environment
        const baseUrl = ("TURBOPACK compile-time truthy", 1) ? window.location.origin.replace('-3000', '-8000') : "TURBOPACK unreachable";
...
//# sourceMappingURL=_13l92wp._.js.map